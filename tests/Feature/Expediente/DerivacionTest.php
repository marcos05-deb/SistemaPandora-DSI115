...
beforeEach(function () {
    ...
    $this->userReferent = User::factory()->create([
        'password' => Hash::make('password'),
        'must_change_password' => false,
    ]);
    $this->userReferent->roles()->attach($this->roleReferent->id);
...
it('can derivar a patient to an area', function () {
    ...
    // Act
    $response = $this->post(route('pacientes.derivar.store', $this->paciente->codigo), [
