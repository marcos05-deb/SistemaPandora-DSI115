            ...
            <aside class="w-[180px] bg-[#3B4252] shadow-xl shrink-0 z-10 flex flex-col">
                <nav class="flex-1 py-4">
                    ...
                    <Link
                        href="/pacientes"
                        class="group flex items-center px-4 py-2.5 text-[14px] font-medium rounded-[8px] transition-all duration-200"
                        :class="$page.url.startsWith('/pacientes') ? 'bg-[#4C566A] text-white shadow-sm' : 'text-[#D8DEE9] hover:bg-[#434C5E] hover:text-white'"
                    >
                        <svg class="mr-3 h-5 w-5 flex-shrink-0 transition-colors" :class="$page.url.startsWith('/pacientes') ? 'text-white' : 'text-[#D8DEE9] group-hover:text-[var(--nord10)]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
