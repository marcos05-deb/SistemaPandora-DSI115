...
<template>
    ...
    <div class="max-w-5xl mx-auto space-y-6 pb-10">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-start bg-white py-[14px] px-[18px] shadow-sm border border-[var(--nord4)] rounded-[10px]">
            <div class="min-w-0">
                <h1 class="text-[16px] font-medium text-[var(--nord0)] tracking-tight flex items-center gap-2">
                    <Link href="/dashboard" class="text-[var(--nord3)] hover:text-[var(--nord0)] transition-colors shrink-0">
